...
def report(
        ...
        min_missing_share: float = typer.Option(0.3,
                                                help="Порог доли пропусков, выше которого колонка считается проблемной (0.0-1.0)."),
) -> None:
    """
    ...
    - top-k категорий по категориальных признаков;
